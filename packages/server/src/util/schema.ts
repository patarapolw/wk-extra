 ...
 * Project specific
 */
export const sQuizDirection = S.string().enum(
  'entry',
  'alt',
  'reading',
  'english'
)
export const sDictType = S.string().enum('cedict', 'edict', 'tatoeba')
export const sQuizTypeStd = S.string().enum(
  'character',
  'jp',
  'zh',
  'jp-sentence',
...
export const sQuizType = S.anyOf(sQuizTypeStd, S.string().enum('extra'))
